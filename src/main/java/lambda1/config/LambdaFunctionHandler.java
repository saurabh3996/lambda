...
public class LambdaFunctionHandler implements RequestHandler<Object, String> {
        ...
        DescribeLogStreamsRequest describeLogStreamsRequest = new DescribeLogStreamsRequest().withLogGroupName( "/ecs/userTask" );
        ...
        String fileName = "usermanagement_"+LocalDateTime.now()+".log";
        ...
        String bucket_name = "usermanagementlogs";
